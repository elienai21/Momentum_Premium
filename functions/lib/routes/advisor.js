...
router.post("/chat", requireAuth_1.requireAuth, withTenant_1.withTenant, async (req, res) => {
...
router.post("/session", requireAuth_1.requireAuth, withTenant_1.withTenant, async (req, res) => {
